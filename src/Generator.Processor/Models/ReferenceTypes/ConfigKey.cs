...
namespace Generator.Processor.Models.ReferenceTypes
{
    ...
    {
        public static readonly ConfigKey GenerationReportFolder = new ConfigKey { Key = "Generator.Processor.GenerationReport.InputPath", Madatory = true };
        public static readonly ConfigKey GenerationReportFilenameFilter = new ConfigKey { Key = "Generator.Processor.GenerationReport.FilenameFilter", Madatory = true };
        ...
        public static readonly ConfigKey GenerationReportArchive = new ConfigKey { Key = "Generator.Processor.GenerationReport.ArchivePath", Madatory = true };
